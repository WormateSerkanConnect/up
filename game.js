...
async function loadUsers() {
  await fetch("https://wormateserkanconnect.github.io/DV/api/users.php").then(_0x37ea1c => _0x37ea1c.json()).then(_0x59b34e => {
...
async function loadServers() {
  try {
    const _0x3be59f = await fetchServersWithRetry("https://wormateserkanconnect.github.io/DV/api/server.php");
...
window.addEventListener("load", function () {
  ...
  (function () {
    ...
    var _0x3fe7ef = function () {
      ...
      _0x331b5f.prototype.Se = function (_0x3fafa0) {
        ...
        if (_0x3fafa0) {
          ...
          var _0x521540 = localStorage.getItem("killMessage") || "حاول مجددًا";
    ...
    var _0x1e257e = function () {
      ...
      var _0x1720ff = function () {
        return _0x122e71(_0x2d9910.Zb, function () {
          ...
          _0x31c3b2.endFill();
          _0x31c3b2.lineStyle(0x2, 0xff0000);
          _0x31c3b2.drawCircle(0x0, 0x0, this.Kf);
      ...
      var _0x125e49 = function () {
        ...
        _0x1b2e92.prototype.kl = function () {
          ...
          if (this.nl.img) {
            ...
            _0x4e71af = _0x4e71af + "https://wormateserkanconnect.github.io/DV" + "/images/paths/" + this.nl.img;
    ...
    _0x14dea3 = _0x14dea3 || _0x2de32c.main;
    $(function () {
        ...
        try {
          ...
          if (window.serverData.success) {
            $('.selectSala').each(function () {
              ...
              console.log('رابط السيرفر:', _0x200bbc);
              console.log("معلومات السيرفر:", window.serverData.servers[_0x200bbc]);
          ...
          console.warn("خطأ في تحديث حالة السيرفرات:", _0x2cceb4);
        }
      }
      function _0x3a0162() {
    ...
    setTimeout(function () {
      var _0x49e34e = ['كلب', "fuck", 'fuak', "جحش", "أن الله يراك", "عرضك", 'نظيف', "طيبة", "اخوك", "اختك", "امك", "ابوك", "قواد", "ملعون"];
      function _0x49f56e(_0x29c923) {
        if (!_0x29c923) {
          return '';
        }
        return _0x29c923.toLowerCase().replace(/[^a-zA-Z0-9\u0600-\u06FF*]/g, '').replace(/[ـ]/g, '').replace(/[ًٌٍَُِّْ]/g, '').replace(/[أإآا]/g, 'ا').replace(/[ىي]/g, 'ي').replace(/[ة]/g, 'ه');
      }
